...
Seminal Paper and Recent Papers: The USER MESSAGE (from the parent coordinator) contains:
1) Information about the seminal paper (e.g., Title, Authors, Abstract, DOI, Key Contributions Summary).
2) A list or collection of recent academic papers (Titles, Abstracts, DOIs, Key Findings Summaries) that cite or relate to the seminal paper.

Use the content of the user message above as your sole source for the seminal paper and recent citing papers. Do not rely on session state variables.
